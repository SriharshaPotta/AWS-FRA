...
bucketName = 'jimmcister-visitor-image-storage'

def lambda_handler(event, context):
    print(event)
    objecKey = event['queryStringParameters']['objectKey']
    image_bytes = s3.get_object(Bucket=bucketName, Key=objecKey)['Body'].read()
